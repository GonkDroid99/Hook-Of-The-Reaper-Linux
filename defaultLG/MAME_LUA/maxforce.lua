...
-- Memory Values								 	--
------------------------------------------------------
_Credits_MemoryAddress = 0x100003E5
_StartLamp = {0, 0}
_PlayerStatus = {0, 0}
_PlayerLife = {0, 0}
_PlayerAmmo = {0, 0}
...
--		GameStatus = mem:read_u8(0x0050003D) -- Not needed for Maximum Force
...
--		_PlayerStatus[i] = mem:read_u8(0x00502088 + (i * 0x04))
		_PlayerLife[i] = mem:read_u8(0x1000AAE3 + (i * 0x8C))
		_PlayerAmmo[i] = mem:read_u8(0x1000AB37 + (i * 0x8C))	
