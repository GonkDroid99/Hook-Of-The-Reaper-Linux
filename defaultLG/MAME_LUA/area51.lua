...
-- Memory Values								 	--
------------------------------------------------------
_Credits_MemoryAddress = 0x100003A5
_StartLamp = {0, 0}
_PlayerStatus = {0, 0}
_PlayerLife = {0, 0}
_PlayerAmmo = {0, 0}
...
--		GameStatus = mem:read_u8(0x0050003D) -- not needed for Area 51
...
--		_PlayerStatus[i] = mem:read_u8(0x00502088 + (i * 0x04))
		_PlayerLife[i] = mem:read_u8(0x1000879B + (i * 0xA8))
		_PlayerAmmo[i] = mem:read_u8(0x1000876F + (i * 0xA8))	
