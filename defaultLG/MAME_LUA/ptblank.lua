...
--		manager.machine.output:set_value("P" .. (i + 1) .. "_LmpStart", _StartLamp[i])
		...
		GameStatus = mem:read_u8(0x210081) -- 1 for active play
...
--		_PlayerStatus[i] = mem:read_u8(0x00502088 + (i * 0x04))
		_PlayerLife[i] = mem:read_u8(0x1C00B3 + (i * 0x2))
		_PlayerAmmo[i] = mem:read_u8(0x210011 + (i * 0x2))	
