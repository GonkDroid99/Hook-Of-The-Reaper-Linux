...
--		_PlayerStatus[i] = mem:read_u8(0x00502088 + (i * 0x04))
		_PlayerLife[i] = mem:read_u8(0x2191 + (i * 0x40))
		_PlayerAmmo[i] = mem:read_u8(0x2193 + (i * 0x40))	
		_StartLamp[i] = mem:read_u8(0x2000) 
	end
